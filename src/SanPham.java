...
public class SanPham {
    ...
    String sql = "SELECT MaSP,TenSP,Dongia,L.Maloai, Tenloai"
            + "FROM Sanpham S, LoaiSP L where L.Maloai=S.Maloai and L.Maloai='" + ml +"'";
    return cn.LoadData(sql);
    }
    ...
    cn.connectDB();
    String sql = "SELECT MaSP,TenSP,Dongia,L.Maloai, Tenloai"
            + "FROM Sanpham S, LoaiSP L where L.Maloai=S.Maloai";
    return cn.LoadData(sql);
    }
    //Truy van du lieu trong Table Sanpham theo MaSP
    public ResultSet ShowSPTheoma(String ma) throws SQLException{
    String sql = "SELECT MaSP,TenSP,Dongia,L.Maloai, Tenloai"
            + "FROM Sanpham S, LoaiSP L where L.Maloai=S.Maloai and MaSP='" + ma +"'";
    return cn.LoadData(sql);
    }
    ...
    public void InsertSanpham(String ma, String ten, int dg, String ml)
    throws SQLException{
    ...
    String sql = "Update Sanpham"
            + "set TenSP=N'" + ten +"',Dongia=" + dg +",Maloai='" + ml +"'"
            + "where MaSP='" + ma +"'";
    cn.UpdateData(sql);
    }
